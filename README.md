# BZ StudyPal - 智能错题管理与复习系统 | BZ StudyPal - Smart Wrong Question Management & Review System
...
BZ StudyPal是一个为K12学生设计的智能错题管理与复习系统，支持中英文双语界面，帮助学生通过科学的错题复习方法提高学习成绩。
...
# 新终端启动前端服务 | Start frontend server in new terminal
cd frontend
pnpm dev
```
